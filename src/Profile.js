        ...
        return (
            <div className="profile">
                <div className="profile-header">
                    <ProfileIcon profilePhoto={profile.profilePhoto} />
                        ...
                        return (
                            <div className="highlight-container" key={highlight.id}>
                                <div className="image-container">
                                    <img src={highlight.photoUrl} alt="highlight" />
                                </div>
                                <div className="highlight-name">{highlight.name}</div>
                            </div>
                        );
                    })} */}
                    <Stories stories={profile.highlights} storiesClass="no-padding no-border" storyClass={"white"}/>
                </div>
                <ul className="meta-section">
                    <li>
                        <span className="totalposts">
                            <span className="text">{profile.metadata.totalposts}</span>posts
                        </span>
                    </li>
                    <li>
                        <span className="totalposts">
                            <span className="text">{profile.metadata.totalfollowers}</span>followers
                        </span>
                    </li>
                    <li>
                        <span className="totalposts">
                            <span className="text">{profile.metadata.totalfollowing}</span>following
                        </span>
                    </li>
                </ul>
                <div className="button-section">
                    <div>
                        <svg aria-label="Posts" class="_8-yf5 " fill="#0095f6" height="24" viewBox="0 0 48 48" width="24">
                            <path
                                clip-rule="evenodd"
                    ...
                    <div>
                        <svg aria-label="Saved" class="_8-yf5 " fill="#8e8e8e" height="24" viewBox="0 0 48 48" width="24">
